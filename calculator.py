...
def button_click(number):
    ...
    entry_field.insert(0, str(current_number) + str(number))
...
button_clean = Button(root, text="Clear", padx=79, pady=20,command=lambda: button_clear())
...
#my_button = Button(root, text="click Here", command=my_click, bg="green")
