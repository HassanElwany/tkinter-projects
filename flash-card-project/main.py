...
class FlashCardApp:
    def __init__(self, window, data):
        ...
        self.flipping = window.after(3000, func=self.flip_card)
        ...
        self.check_button = Button(image=self.check_image, highlightthickness=0, command=self.next_card)
    ...
    def next_card(self):
        ...
        self.flipping = self.window.after(3000, func=self.flip_card)
